...
For each step(input, Alphabetizer, CircularShifter), you will be asked to choose if output the upper case results. Enter 1 to output it to the console window, enter 2 to output to a file. You still DO NOT have to enter the '.txt' part.