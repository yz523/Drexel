...
public class CityInfoController {
	...
	private class AddCityListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if(model != null){
				String city = inputView.jtfName.getText();
				...
				City c = new City(city, state, population, year);
				model.addToCitList(c);;
			}
		}
	}
	...
	public void setInputWindow(CityInfoInputWindow theView) {
		...
		// Register listeners for clearCityList and clearInputFields
